...
// Ключ Supabase (service_role предпочтителен, но благодаря чтению через вью
// подойдёт любой ключ проекта). Клиент создаётся лениво, чтобы чистые функции
// можно было импортировать/тестировать без env.
let _client = null;
function getClient() {
